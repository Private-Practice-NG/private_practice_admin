  ...
  return (
    <div className="flex flex-wrap items-start justify-between gap-8">
      ...
      <div className="block w-full bg-[#ECECEC] p-3 rounded-lg lg:min-h-[410px]">
        <h1 className="font-normal text-lg mb-4 poppins">Hospitals</h1>
      ...
      {/* Specialist section */}
      <div className="block w-full bg-[#ECECEC] p-3 rounded-lg lg:min-h-[410px]">
        <h1 className="font-normal text-lg poppins">Specialists</h1>
        <section className="flex flex-col justify-between mt-6 min-h-[450px]">
          ...
          <Link
            to="/specialists"
            className="poppins w-full border-2 border-[#10ACF5] bg-[#10ACF5] text-white text-center text-xs py-3 rounded-lg mt-4"
          >
            View All
          </Link>
        </section>
